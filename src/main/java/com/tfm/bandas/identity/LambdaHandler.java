package com.tfm.bandas.identity;
...
/**
 * Punto de entrada de AWS Lambda para MS Identity.
...
public class LambdaHandler implements RequestHandler<HttpApiV2ProxyRequest, AwsProxyResponse> {
    ...
    static {
        try {
            handler = SpringBootLambdaContainerHandler.getHttpApiV2ProxyHandler(IdentityApplication.class);
